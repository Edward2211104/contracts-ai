...
// Handle CORS preflight explicitly (important for browser UI)
app.options('*', cors());
...
// Narrow preflight for LLM endpoints
app.options('/llm/*', (req, res) => res.sendStatus(204));
